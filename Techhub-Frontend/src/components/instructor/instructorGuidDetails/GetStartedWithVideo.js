...
import startedWithVideo from "../../../Images/getStartedWithVideo.jpg";
import { BiArrowBack } from "react-icons/bi";
import InstructorOffCanvas from "../InstructorOffCanvas";
import BackButton from "../../SharedComponents/BackButton";

const GetStartedWithVideo = () => {
  return (
        ...
        <Row>
          ...
          <Col md={8}>
            <div className="text-center">
              <img src={startedWithVideo} alt="createcourseimage " />
            </div>
...
export default GetStartedWithVideo;
