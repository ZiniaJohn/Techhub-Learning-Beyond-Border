...
import instructorChallenge from "../../../Images/NewInstructorChallenge.jpg";
import InstructorOffCanvas from "../InstructorOffCanvas";
import BackButton from "../../SharedComponents/BackButton";
const InstructorChallenge = () => {
  return (
        ...
        <Row>
          ...
          <Col md={8}>
            <div className="text-center">
              <img src={instructorChallenge} alt="createcourseimage " />
            </div>
            <h1 className="text-center mt-5">
              Engage By creating Video Content
            </h1>
            <h5 className="mt-4">
...
export default InstructorChallenge;
