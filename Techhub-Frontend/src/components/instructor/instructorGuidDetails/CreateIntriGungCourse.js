        ...
        <Row>
          ...
          <Col md={8}>
            <div className="text-center">
              <img src={EngagingCourse} alt="createcourseimage " />
            </div>
            <h1 className="text-center mt-5">Create An Engaging Course</h1>
            <h5 className="mt-4">
                ...
                <Accordion>
                  <Accordion.Item eventKey="0">
                    ...
                    <Accordion.Body>
                      ...
                      These components are structured into sections and lectures
                  ...
                  <Accordion.Item eventKey="1">
                    ...
                    <Accordion.Body>
                      The only length requirement for a course is that it must
                      be at least 30 minutes. Your course should be as long as
                      it takes to fully teach your topic and allow your students
                      to achieve the course goals. If you’re unsure, you can
                      also take a look at other courses in your category to get
                      a sense for the average course length of similar courses.
                    </Accordion.Body>
                  </Accordion.Item>
                  <Accordion.Item eventKey="2">
                    <Accordion.Header>
                    ...
                    <Accordion.Body>
                      Course creation time varies greatly depending on the
                      length of the course and an instructor's time commitment.
                      Many of our instructors complete their courses in 30-45
                      days.
                    </Accordion.Body>
                  </Accordion.Item>
                  <Accordion.Item eventKey="3">
                    ...
                    <Accordion.Body>
                      ...
                      quizzes, practice tests, coding exercises, and assignments
                      in your course.
                    </Accordion.Body>
                  </Accordion.Item>
                  <Accordion.Item eventKey="4">
                    ...
                    <Accordion.Body>
                      Courses must contain at least 30 minutes of content,
                      include at least 5 separate lectures, and videos must be
                      HD quality. See here for a complete list of the minimum
                      course requirements.
                    </Accordion.Body>
                  </Accordion.Item>
                </Accordion>
...
export default CreateIntriGungCourse;
