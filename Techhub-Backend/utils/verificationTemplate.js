...
<body>
  <div class="container">
    ...
    <p>Thank you for registering with Techhub, your online learning platform. To get started, please verify your email address by clicking the button below:</p>
  ...
  return `<!DOCTYPE html>
    ...
    <body>
      <div class="container">
        ...
        <p>Your email has been successfully verified. You are now ready to explore Techub, your online learning platform.</p>
        ...
        <p>Thank you for choosing Techhub! If you have any questions or need assistance, feel free to contact our support team.</p>
      </div>
    </body>
    </html>
    `;
